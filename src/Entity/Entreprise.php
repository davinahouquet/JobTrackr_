...
class Entreprise
{
    ...
    private ?string $lien_entreprise = null;
    ...
    {
        return $this->lien_entreprise;
    }

    public function setLienEntreprise(?string $lien_entreprise): static
    {
        $this->lien_entreprise = $lien_entreprise;
